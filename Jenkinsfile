pipeline {
  ...
  environment {
    ...
    DOCKERHUB_IMAGE = 'linuxserver/projectsend'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/projectsend'
    PR_DOCKERHUB_IMAGE = 'lspipepr/projectsend'
    DIST_IMAGE = 'alpine'
    MULTIARCH='true'
    CI='true'
    CI_WEB='true'
  ...
  stages {
    ...
    stage("Scarf.sh package registry"){
      ...
      steps{
        sh '''#! /bin/bash
              PACKAGE_UUID=$(curl -X GET -H "Authorization: Bearer ${SCARF_TOKEN}" https://scarf.sh/api/v1/organizations/linuxserver-ci/packages | jq -r '.[] | select(.name=="linuxserver/projectsend") | .uuid' || :)
              if [ -z "${PACKAGE_UUID}" ]; then
                echo "Adding package to Scarf.sh"
                curl -sX POST https://scarf.sh/api/v1/organizations/linuxserver-ci/packages \
                  -H "Authorization: Bearer ${SCARF_TOKEN}" \
                  -H "Content-Type: application/json" \
                  -d '{"name":"linuxserver/projectsend",\
                       "shortDescription":"example description",\
                       "libraryType":"docker",\
                       "website":"https://github.com/linuxserver/docker-projectsend",\
                       "backendUrl":"https://ghcr.io/linuxserver/projectsend",\
                       "publicUrl":"https://lscr.io/linuxserver/projectsend"}' || :
              else
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-projectsend/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-projectsend\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-projectsend\" \
